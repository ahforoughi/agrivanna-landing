...
import { Stethoscope, Brain, Shield, Users, ArrowRight, Menu, X, CheckCircle, Star, Globe, DollarSign, Settings, Linkedin } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/services#virtual-grazing" className="text-gray-300 hover:text-white transition-colors">Virtual Grazing Management</Link></li>
                <li><Link href="/services#ai-weighing" className="text-gray-300 hover:text-white transition-colors">AI-Enhanced Smart Weighing</Link></li>
                <li><Link href="/services#health-monitoring" className="text-gray-300 hover:text-white transition-colors">Health & Behavior Monitoring</Link></li>
                <li><Link href="/services#lifecycle-management" className="text-gray-300 hover:text-white transition-colors">Livestock Lifecycle Management</Link></li>
              </ul>
            </div>
