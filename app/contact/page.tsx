...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const subject = encodeURIComponent(formData.subject || 'Contact from Agrivanna Website')
...
${formData.message}
      ...
      window.location.href = `mailto:info@agrivanna.com?subject=${subject}&body=${body}`
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2A5F36] focus:border-transparent"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#2A5F36] focus:border-transparent resize-none"
                    placeholder="Tell us about your livestock management needs, farm size, or any questions you have..."
                  />
                </div>

                {submitStatus === 'success' && (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    <p className="text-green-800">Thank you for your message! Your email client should open to send the message.</p>
                  </div>
                )}
                ...
                <Button
                  ...
                  className="w-full bg-[#2A5F36] hover:bg-[#637D59] text-white text-lg px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg"
                >
